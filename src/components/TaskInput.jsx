    ...
    >
      ...
      >
        ...
        <input
          ...
          placeholder="Add task…  !high !med !low"
          style={{
            flex: 1,
...
const PlusIcon = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" style={{ color: 'var(--text-secondary)', flexShrink: 0 }}>
