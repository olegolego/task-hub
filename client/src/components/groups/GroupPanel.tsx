            ...
            <div style={{ display: 'flex', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              <button
                ...
                style={{
                  ...
                  border: 'none',
                  borderBottom:
                    activeTab === 'tasks' ? '2px solid var(--accent)' : '2px solid transparent',
              ...
              <button
                onClick={() => {
                  setActiveTab('chat')
                  useGroupChatStore.getState().setActiveGroup(activeGroupId)
                  useGroupChatStore.getState().loadHistory(activeGroupId)
                }}
                style={{
                  flex: 1,
                  padding: '6px',
                  ...
                  border: 'none',
                  borderBottom:
                    activeTab === 'chat' ? '2px solid var(--accent)' : '2px solid transparent',
                  ...
                  <div key={req.inviteId} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    <span
                      style={{
                        ...
                        height: 20,
                        borderRadius: '50%',
                        background: req.requesterColor || '#4361ee',
                        flexShrink: 0,
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'center',
                    ...
                    <span style={{ fontSize: 11, color: 'var(--text-secondary)', flex: 1 }}>
                      <b style={{ color: 'var(--text-primary)' }}>{req.requesterName}</b> wants to
                      join
                    </span>
                    <button
    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      {showCreate && (
        <form
          ...
          style={{ padding: '8px 10px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}
        >
            ...
            <div key={inv.inviteId} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <div
                style={{
                  ...
                  height: 8,
                  borderRadius: '50%',
                  background: inv.groupColor || 'var(--accent)',
                  flexShrink: 0,
                }}
              />
